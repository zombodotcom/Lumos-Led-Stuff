...
// Pin definitions
#define MSGEQ7_STROBE_PIN 15 
#define MSGEQ7_RESET_PIN  13
#define ADC2_TEST_CHANNEL (ADC2_CHANNEL_2)      // GPIO 2
...
void print_audio() {
  for (int band = 0; band < 7; band++) {
    ...
    Serial.print("\t");
      display.drawString(0, 0, "Audio Pattern");
      display.drawString(10,band*3, (String)spectrumByte[band]);
  }
  Serial.println();
  display.clear();
