...
#define LONG_SLEEP  120       /* Time ESP32 will go to sleep (in seconds) */
...
#define DATA_PINLM   26
#define DATA_PINRR   14
#define DATA_PINRM   27
...
//  FastLED.addLeds<LED_TYPE, DATA_PIN, COLOR_ORDER>(leds, NUM_LEDS).setCorrection(TypicalLEDStrip);
  ...
  FastLED.addLeds<LED_TYPE,DATA_PINRR,COLOR_ORDER>(leds, NUM_LEDS).setCorrection(TypicalLEDStrip);
   FastLED.addLeds<LED_TYPE,DATA_PINRM,COLOR_ORDER>(leds, NUM_LEDS).setCorrection(TypicalLEDStrip);
      FastLED.addLeds<LED_TYPE,DATA_PINLM,COLOR_ORDER>(leds, NUM_LEDS).setCorrection(TypicalLEDStrip);
...
if (bootCount<1000){
  ...
  for (int i =1; i < 100; i++){
 if (bootCount<=i+100){
     esp_sleep_enable_timer_wakeup(TIME_TO_SLEEP*i * uS_TO_S_FACTOR);
